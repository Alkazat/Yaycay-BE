// Structural validation for trip_content writes. Mirrors the required-field
// rules of schemas/trip-content.schema.json (the canonical schema lives in
// @alkazat/contracts). Shared by the customer trips function and the admin
// content-review path so the two stay in lockstep.
