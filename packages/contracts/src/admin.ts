...
/**
 * Lifecycle of an account in the admin Users list:
 * - `invited`: a magic-link invite was sent but they've never signed in.
 * - `active`: they have signed in at least once.
 * - `deletion-requested`: a deletion is pending execution.
 */
